...
"""
import os, re
from lib import utils, PLUGINDIR
...
class Plugin(BasePlugin):
    ...
    @threaded_method
    def enable(self):
        self.update_url = self.pi_dash.config.get(self.namespace, 'url', DEFUALT_URL)
...
class Config(BaseConfig):
    TEMPLATE = os.path.join(PLUGINDIR, 'externalip_config.html')
